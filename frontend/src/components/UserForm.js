    ...
    return (
        <div className="container mt-5">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    <label>Banner</label>
                    <input type="text" className="form-control" value={banner} onChange={(e) => setBanner(e.target.value)} required />
                </div>
                <div className="form-group">
                    <label>Logo</label>
                    <input type="text" className="form-control" value={logo} onChange={(e) => setLogo(e.target.value)} required />
                </div>
                <div className="form-group">
                    <label>Date</label>
